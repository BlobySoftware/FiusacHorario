...
class Home extends Component{
  ...
  render(){
	...
	<div id="mainMsj">
	  <h4>Bienvenido</h4>
	  <p>Aqui encontraras información sobre los cursos de la facultad, asi como administrar tus cursos del semestre.</p>
	  <div id="logoDiv">
	    <img src={process.env.PUBLIC_URL+'/img/icn.png'} alt="App icon"/>
	    <h4>FIUSAC Horario<br/>
	    <p>Esta applicación es independiente de la facultad y aún se encuentra en desarrollo.</p></h4>
	  </div>
	</div>
      </div>
    )
